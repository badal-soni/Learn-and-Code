...
public final class ApiUrls {
    ...
    public static final String UNHIDE_CATEGORY = BASE_URL + "/categories/unhide";
    public static final String HIDDEN_CATEGORIES = BASE_URL + "/categories/hidden";
    public static final String UNHIDDEN_CATEGORIES = BASE_URL + "/categories/unhidden";

    public static final String NEWS = BASE_URL + "/news";
    public static final String NEWS_ID = BASE_URL + "/news/%s";
    ...
    public static final String CATEGORY_HEADLINES = NEWS + "/%s/headlines?from=%s&to=%s";
    public static final String DATE_RANGE_HEADLINES = HEADLINES + "?from=%s&to=%s";
    public static final String SEARCH_NEWS = BASE_URL + "/news/search";
    public static final String REPORT_NEWS = BASE_URL + "/news/%s/report";
    ...
    public static final String HIDE_NEWS_BY_KEYWORDS = NEWS + "/hide/keywords";
    ...
    public static final String TOGGLE_KEYWORD_ACTIVE_STATUS = BASE_URL + "/keywords/%s/status/toggle";

    public static final String SAVE_NEWS = NEWS + "/%s/save";
    public static final String UNSAVE_NEWS = NEWS + "/%s/unsave";
    public static final String TOGGLE_LIKE = NEWS + "/%s/toggle-like";
